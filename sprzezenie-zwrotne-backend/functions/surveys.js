...
const getCoursesAvailableToSurvey = async function (token, userdata) {
    //Zmienione na metode studenta na potrzeby developmentu
    //url = 'https://usosapps.umk.pl/services/courses/coordinator'
    ...
    returnObject = await got(url, {
        ...
        searchParams: {
            //Pole o ktore sie pyta w usos api (w teorii inne niz dla studentow) - do sprawdzenia
            //fields: "course",
